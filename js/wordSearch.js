...
function applyChanges() {
    numLimitSyl = parseInt($("#sylgroup").find(".active").attr("value"));
    numLimitLet = parseInt($("#letgroup").find(".active").attr("value"));
    ...
    setTimeout(function() {
        $('#alert').html('<div id="alert"><div id="fade" class="alert alert-success alert-dismissable fade in" style="font-size:small"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Changes applied!</div></div>');
    }, 2100);
...
function cancelChanges() {
    setTimeout(function() {
        ...
        $("#sylgroup").find(".active").removeClass("active");
        $('#sylgroup .syl[value=' + numLimitSyl + ']').addClass("active");

        // revert letter limit
        $("#letgroup").find(".active").removeClass("active");
        ...
        $('#alert').html('<div id="alert"><div id="fade" class="alert alert-danger alert-dismissable fade in" style="font-size:small"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>No changes made!</div></div>');
    }, 2100);
